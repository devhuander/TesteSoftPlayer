...
type
  ...
  public
    ...
    procedure TestVerificarTabela(const aTabela: String; const aExcept : String = '');
  end;
...
procedure TTestSPQuery.TestVerificarTabela(const aTabela: String; const aExcept : String);
var
  StrList: TStringList;
  i: Integer;
begin
  try
    ...
    else Assert.WillNotRaiseAny(SPQuery.VerificarTabela, 'Não gerou exception!');
