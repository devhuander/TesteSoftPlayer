...
uses
  ...
  Vcl.DBGrids, Vcl.Mask, Datasnap.DBClient, Controller.Tarefa3, Interfaces.Tarefa3;
...
begin
  edtTotal.Text := FormatFloat(',0.00', Tarefa3.RetornaTotal);
end;

procedure TfTarefa3.btnDivisoesClick(Sender: TObject);
begin
  edtDivisoes.Text := FormatFloat(',0.00', Tarefa3.RetornaDivisao);
end;
